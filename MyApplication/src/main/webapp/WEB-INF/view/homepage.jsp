...
<div class="container-fluid text-center">    
  <div class="row content">
    ...
    <div class="col-sm-8 text-left"> 
      ...
      <hr>
      <h3>Caring for your employees should be central to any employee management system. This approach can take a few forms:</h3>
      <p>1.Caring about each employee equally.
